...
export class KeycloakDriver extends Oauth2Driver<KeycloakDriverAccessToken, KeycloakDriverScopes> {
   ...
   */
  protected authorizeUrl = 'http://localhost:8080/auth/realms/lab/protocol/openid-connect/auth'
   ...
   * Do not define query strings in this URL.
   */
  protected accessTokenUrl = 'http://localhost:8080/auth/realms/lab/protocol/openid-connect/token'
   ...
   * Do not define query strings in this URL.
   */
  protected userInfoUrl = 'http://localhost:8080/auth/realms/lab/protocol/openid-connect/userinfo'
